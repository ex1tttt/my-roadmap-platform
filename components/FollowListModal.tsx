...
export default function FollowListModal({
  ...
  return (
    ...
    >
      {/* Панель */}
      <div
        className="relative w-full max-w-md rounded-2xl border border-white/10 bg-zinc-900 shadow-xl"
                ...
                >
                  ...
                  {mode === 'following' && canUnfollow && (
                    <button
                      ...
                      className="shrink-0 flex items-center gap-1.5 rounded-lg border border-slate-700 bg-slate-800 px-2.5 py-1 text-xs font-medium text-slate-300 transition-all hover:border-red-500/40 hover:bg-red-950/40 hover:text-red-400 disabled:cursor-not-allowed disabled:opacity-50"
                    >
